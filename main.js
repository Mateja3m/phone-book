// Prevention of deletion added content after page loading
window.addEventListener('beforeunload', save);

//Select Elements
let accountsTableBody = document.querySelector("#acc-table-body"); //for table functionality
...
//Grabing links, swiching betwen the pages smothly
...
<tr>
	...
	<td>${account.email}</td>
  <td>${account.phone}</td>
  <td><button data-id="${i}" class="edit-btn btn btn-sm btn-success form-control">Edit</button></td>
...
function deleteAccount() {
  ...
  db.splice(id, 1);
  createAccountsTable('#accounts-view');
